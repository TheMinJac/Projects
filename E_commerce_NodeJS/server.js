...
app.get('/GTAV', function(req, res){
  var file = __dirname + '/Grand Theft Auto V.exe';
  res.download(file); // Set disposition and send it.
});
...
app.post('/testhref', (request, response) => {
...
app.get('/testhref', (request, response) => {

response.render('pages/index', {tabs: 'testhref', prenom:request.session.prenom})
...
///ici c'est pour appeler la page meuble
app.get('/meuble', (request, response) => {

response.render('pages/index', {tabs: 'meuble', prenom:request.session.prenom})
console.log("meuble")
...
app.get('/profile', (request, response) => {
    ...
    Login.search(request.session.idUser, function(result) {
        ...
        {
            response.render('pages/index', {tabs: 'profile', result:result})
        }
    })
    ...
    Login.search(request.session.idUser, function(result) {
        ...
        else
        {
            Login.modifyUser(request.session.idUser,request.body, function(result2){
                response.render('pages/index', {tabs: 'profile', result:request.body})
            })
...
console.log("shop")
    Shop.listProduits(function(result) {
        ...
        else
        {
            ...
            response.render('pages/index', {tabs: 'shop', result:result})
    ...
    Shop.listProduits(function(result) {
        ...
        else
        {
            Shop.listFonds(function(resultFonds) {
                ...
                response.render('pages/index', {tabs: 'administration', result:result, resultFonds:resultFonds})
